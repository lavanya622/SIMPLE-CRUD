let data = [
    {id:1,name:"lisa",email:"lisa@gmail.com"},
    {id:2,name:"luna",email:"luna@gmail.com"}
]
function readAll() {
...
function edit(id) {
    ...
    document.querySelector('.unname').value = obj.name;
...
function update() {
    ...
    var name =  document.querySelector('.unname').value;
